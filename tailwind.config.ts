  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          '0%, 100%': { boxShadow: '0 0 5px rgba(138, 43, 226, 0.3)' },
          '50%': { boxShadow: '0 0 20px rgba(138, 43, 226, 0.6)' },
        },
        shine: {
      ...
      backgroundImage: {
        ...
        'gradient-luxury': 'linear-gradient(to right, #434343 0%, black 100%)',
        'gradient-cosmos': 'linear-gradient(to right, #000046, #1CB5E0)',
        'gradient-sunset': 'linear-gradient(to right, #ee9ca7, #ffdde1)',
      },
      boxShadow: {
        'elegant': '0 10px 30px -10px rgba(138, 43, 226, 0.3)',
      },
    },
  },
